...
<div class="container">
    ...
    <div class="row">
        <div class="col-sm-4 card">
            ...
            <div class="card-content">
                ...
                <div class="card-modal">
                    <h2 class="card-title">Product Development</h2>
                    <p>
                    ...
                    <h2 class="card-title">Product Specification</h2>
                    <p>
        ...
        <div class="col-sm-4 card">
            <div class="card-header">
                <div class="image-wrapper">
                    <img src="img/icons/supplier_assessment.svg" />
                </div>
                <strong>
        ...
        <div class="col-sm-4 card">
            ...
            <div class="card-content">
                {{--<h1 class="card-title">Title</h1>--}}
                <div class="card-modal">
                    <h2 class="card-title">Sample Consolidation</h2>
                    <p>
    ...
    <div class="row">
        <div class="col-sm-4 card">
            ...
            <div class="card-content">
                {{--<h1 class="card-title">Title</h1>--}}
                <div class="card-modal">
                    <h2 class="card-title">Regulation Report</h2>
                    <p>
        ...
        <div class="col-sm-4 card">
            ...
            <div class="card-content">
                {{--<h1 class="card-title">Title</h1>--}}
                <div class="card-modal">
                    <h2 class="card-title">Factory Check</h2>
                    <p>
        ...
        <div class="col-sm-4 card">
            ...
            <div class="card-content">
                {{--<h1 class="card-title">Title</h1>--}}
                <div class="card-modal">
                    <h2 class="card-title">Final Confirmation</h2>
                    <p>
    ...
    <div class="row">
        <div class="col-sm-4 card">
            ...
            <div class="card-content">
                {{--<h1 class="card-title">Title</h1>--}}
                <div class="card-modal">
                    <h2 class="card-title">Payment to the Factory</h2>
                    <p>
        ...
        <div class="col-sm-4 card">
            ...
            <div class="card-content">
                {{--<h1 class="card-title">Title</h1>--}}
                <div class="card-modal">
                    <h2 class="card-title">Continual Monitoring</h2>
                    <p>
